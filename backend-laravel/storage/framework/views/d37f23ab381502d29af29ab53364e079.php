<?php $__env->startSection('title', 'Android Testing'); ?>
<?php $__env->startSection('kicker', 'Appium Metrics'); ?>
...
<form method="POST" action="<?php echo e(route('android-tests.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
            ...
            <div class="g-card">
                ...
                <div class="g-form-grid">
                    ...
                    <div class="g-form-field">
                        ...
                        <select class="g-select" name="flow_type" required>
                            <?php $__currentLoopData = ['login', 'signup', 'search', 'button_click', 'form_submit']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $flow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($flow); ?>" <?php if(old('flow_type', 'login') === $flow): echo 'selected'; endif; ?>><?php echo e($flow); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="g-form-field">
                    ...
                    <div class="g-form-field">
                        ...
                        <input class="g-input" name="apk_path" placeholder="Optional when uploading APK" value="<?php echo e(old('apk_path')); ?>">
                    </div>
            ...
            <div class="g-grid g-grid-2">
                <div class="g-card">
                    ...
                    <div class="g-form-grid" style="grid-template-columns: 1fr;">
                        ...
                        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name => $meta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="g-form-field">
                                <label><?php echo e($meta[0]); ?></label>
                                <input class="g-input" type="number" step="<?php echo e($meta[2]); ?>" name="<?php echo e($name); ?>" value="<?php echo e(old($name, $meta[1])); ?>">
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="g-form-field">
                            ...
                            <select class="g-select" name="task_completed">
                                <option value="1" <?php if(old('task_completed', '1') === '1'): echo 'selected'; endif; ?>>1 - Yes</option>
                                <option value="0" <?php if(old('task_completed') === '0'): echo 'selected'; endif; ?>>0 - No</option>
                            </select>
                        </div>
                        ...
                        <div class="g-form-field">
                            ...
                            <select class="g-select" name="task_failed">
                                <option value="0" <?php if(old('task_failed', '0') === '0'): echo 'selected'; endif; ?>>0 - No</option>
                                <option value="1" <?php if(old('task_failed') === '1'): echo 'selected'; endif; ?>>1 - Yes</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="g-card">
                    ...
                    <div class="g-form-grid" style="grid-template-columns: 1fr;">
                        <?php $__currentLoopData = [
                            ...
                            <div class="g-form-field">
                                <label><?php echo e($meta[0]); ?></label>
                                <input class="g-input" type="number" step="0.01" name="<?php echo e($name); ?>" value="<?php echo e(old($name, $meta[1])); ?>">
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="g-form-field">
                            ...
                            <select class="g-select" name="error_message_present">
                                <option value="1" <?php if(old('error_message_present', '1') === '1'): echo 'selected'; endif; ?>>1 - Yes</option>
                                <option value="0" <?php if(old('error_message_present') === '0'): echo 'selected'; endif; ?>>0 - No</option>
                            </select>
                        </div>
                        ...
                        <?php $__currentLoopData = ['popup_detected' => 'Popup Detected', 'overlay_blocks_action' => 'Overlay Blocks Action', 'timeout_occurred' => 'Timeout Occurred', 'crash_detected' => 'Crash Detected', 'anr_detected' => 'ANR Detected']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="g-form-field">
                                <label><?php echo e($label); ?></label>
                                <select class="g-select" name="<?php echo e($name); ?>">
                                    <option value="0" <?php if(old($name, '0') === '0'): echo 'selected'; endif; ?>>0 - No</option>
                                    <option value="1" <?php if(old($name) === '1'): echo 'selected'; endif; ?>>1 - Yes</option>
                                </select>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>

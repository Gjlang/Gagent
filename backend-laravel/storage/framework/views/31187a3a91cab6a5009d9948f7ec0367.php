    ...
    <div class="g-split">
        <div class="g-nav">
            ...
            <div class="g-nav-links">
                <a href="<?php echo e(route('register')); ?>" class="active">Sign Up</a>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FYP\GAgent\GAgent\backend-laravel\resources\views/auth/register.blade.php ENDPATH**/ ?>
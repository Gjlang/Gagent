...
<div class="g-page-header">
    ...
    <div class="g-actions">
        <a class="g-btn g-btn-dark" href="<?php echo e(route('projects.create')); ?>">+ Create Project</a>
    </div>
</div>
...
<div class="g-layout-2-1">
    ...
    <aside class="g-panel">
        ...
        <div style="margin-top: 16px; display: grid; gap: 10px;">
            <a class="g-btn g-btn-primary g-btn-block" href="<?php echo e(route('live-tests.create')); ?>">Run Website Test</a>

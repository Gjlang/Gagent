...
<style>
     ...
     * ---------------------------------------------------------------
     * If layouts.guest wraps <?php echo $__env->yieldContent('content'); ?> in its own centered
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <div class="g-error"><?php echo e($message); ?></div>
                        <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="g-visual-side">
            <div class="g-visual-logo-wrap">
                <img src="<?php echo e(asset('images/gagent-logo.png')); ?>" alt="GAgent logo">
            </div>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\FYP\GAgent\GAgent\backend-laravel\resources\views/auth/login.blade.php ENDPATH**/ ?>